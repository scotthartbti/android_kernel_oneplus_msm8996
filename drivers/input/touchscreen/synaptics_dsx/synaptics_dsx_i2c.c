...
#if defined(CONFIG_SECURE_TOUCH)
static int synaptics_rmi4_clk_prepare_enable(struct synaptics_rmi4_data
					     *rmi4_data)
{
	int ret;
...
static void synaptics_rmi4_clk_disable_unprepare(struct synaptics_rmi4_data
						 *rmi4_data)
{
